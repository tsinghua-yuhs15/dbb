...
public class short_message {
	...
	public static void sendMsg(String context, String tel_id) throws Exception {
		
		// 用户名
		String name="13717615001"; 
		// 密码
		String pwd="A7E2DDB8A552FB0ADCE1FDFD9818"; 
		// 电话号码字符串，中间用英文逗号间隔
		StringBuffer mobileString=new StringBuffer(tel_id);
		// 内容字符串
